...
device_folder = 'Device22'
device_partitions_patientwise = 'Device22/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device22] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device22] No TPHG cache found for patient {patient_id}.")
    return None
