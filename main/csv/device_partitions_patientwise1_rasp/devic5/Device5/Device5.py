device_lookup_path = '/home/pi/devic5/newAll_Device_Lookup_with_Probabilities.csv'
...
device_folder = 'Device5'
device_partitions_patientwise = 'Device5/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device5] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device5] No TPHG cache found for patient {patient_id}.")
    return None
