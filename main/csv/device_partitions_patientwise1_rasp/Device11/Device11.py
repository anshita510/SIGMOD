...
device_folder = 'Device11'
device_partitions_patientwise = 'Device11/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device11] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device11] No TPHG cache found for patient {patient_id}.")
    return None
