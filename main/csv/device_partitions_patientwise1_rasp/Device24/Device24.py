...
device_folder = 'Device24'
device_partitions_patientwise = 'Device24/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device24] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device24] No TPHG cache found for patient {patient_id}.")
    return None
