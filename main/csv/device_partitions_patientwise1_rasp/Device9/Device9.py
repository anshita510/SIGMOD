...
device_folder = 'Device9'
device_partitions_patientwise = 'Device9/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device9] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device9] No TPHG cache found for patient {patient_id}.")
    return None
