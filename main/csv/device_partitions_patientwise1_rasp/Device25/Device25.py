...
device_folder = 'Device25'
device_partitions_patientwise = 'Device25/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device25] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device25] No TPHG cache found for patient {patient_id}.")
    return None
