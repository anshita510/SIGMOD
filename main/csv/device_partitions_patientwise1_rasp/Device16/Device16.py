...
device_folder = 'Device16'
device_partitions_patientwise = 'Device16/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device16] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device16] No TPHG cache found for patient {patient_id}.")
    return None
