...
device_folder = 'Device18'
device_partitions_patientwise = 'Device18/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device18] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device18] No TPHG cache found for patient {patient_id}.")
    return None
