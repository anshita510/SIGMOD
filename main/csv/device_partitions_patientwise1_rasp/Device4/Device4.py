...
device_folder = 'Device4'
device_partitions_patientwise = 'Device4/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device4] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device4] No TPHG cache found for patient {patient_id}.")
    return None
