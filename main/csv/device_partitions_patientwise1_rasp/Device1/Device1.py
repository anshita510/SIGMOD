...
device_folder = 'Device1'
device_partitions_patientwise = 'Device1/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device1] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device1] No TPHG cache found for patient {patient_id}.")
    return None
