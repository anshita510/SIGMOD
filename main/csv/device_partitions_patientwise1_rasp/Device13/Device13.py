...
device_folder = 'Device13'
device_partitions_patientwise = 'Device13/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device13] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device13] No TPHG cache found for patient {patient_id}.")
    return None
