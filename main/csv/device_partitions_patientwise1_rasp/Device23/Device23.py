...
device_folder = 'Device23'
device_partitions_patientwise = 'Device23/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device23] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device23] No TPHG cache found for patient {patient_id}.")
    return None
