...
device_folder = 'Device12'
device_partitions_patientwise = 'Device12/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device12] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device12] No TPHG cache found for patient {patient_id}.")
    return None
