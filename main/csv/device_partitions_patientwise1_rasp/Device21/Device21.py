...
device_folder = 'Device21'
device_partitions_patientwise = 'Device21/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device21] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device21] No TPHG cache found for patient {patient_id}.")
    return None
