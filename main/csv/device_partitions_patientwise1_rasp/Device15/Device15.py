...
device_folder = 'Device15'
device_partitions_patientwise = 'Device15/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device15] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device15] No TPHG cache found for patient {patient_id}.")
    return None
