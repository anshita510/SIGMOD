...
device_folder = 'Device2'
device_partitions_patientwise = 'Device2/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device2] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device2] No TPHG cache found for patient {patient_id}.")
    return None
