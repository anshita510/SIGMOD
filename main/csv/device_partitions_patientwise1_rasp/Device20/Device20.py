...
device_folder = 'Device20'
device_partitions_patientwise = 'Device20/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device20] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device20] No TPHG cache found for patient {patient_id}.")
    return None
...
def handle_request(protocol):
    ...
    while True:
        try:
            ...
            print(f"[{device_folder}] Error during packet handling: {e}")
