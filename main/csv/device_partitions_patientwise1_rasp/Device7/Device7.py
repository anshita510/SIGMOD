...
device_folder = 'Device7'
device_partitions_patientwise = 'Device7/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device7] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device7] No TPHG cache found for patient {patient_id}.")
    return None
