...
device_folder = 'Device8'
device_partitions_patientwise = 'Device8/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device8] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device8] No TPHG cache found for patient {patient_id}.")
    return None
