...
device_folder = 'Device19'
device_partitions_patientwise = 'Device19/'
...
def load_tphg(patient_id):
    ...
    if os.path.exists(cache_file):
        print(f"[Device19] TPHG cache loaded for patient {patient_id}")
    ...
    print(f"[Device19] No TPHG cache found for patient {patient_id}.")
    return None
